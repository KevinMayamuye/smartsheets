        ...
        {tab === "overview" && (
          <section className="profile-panel" role="tabpanel">
            <p className="profile-lead">
              Hello, <strong>{user.name}</strong>. You are signed in as a <strong>{user.role}</strong>.
            </p>
            <p className="profile-muted">
              Use the Account tab to review your details. Manage your sheets from the sidebar.
            </p>
          </section>
        )}
